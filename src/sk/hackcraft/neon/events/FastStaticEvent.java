...
/**
 * <p>Implementation of {@link Event} suitable for scenarios, when firing of event
 * have to be as fast as possible, but attaching/removing listeners is scarce.</p*
 */
public final class FastStaticEvent<T> implements Event<T>
{
	...
	{
		attachListener(listener, ImmediateExecuter.getInstance());
	}
